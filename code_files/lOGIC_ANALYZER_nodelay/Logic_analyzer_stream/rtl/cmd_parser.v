                ...
                if (rx_byte == 8'h0A || rx_byte == 8'h0D) begin
                    if (len != 0) begin
                        if (len == 5 &&
                            ...
                            if ((dec_value(line[5]) * 4'd10) + dec_value(line[6]) > 4'd9)
                                rate_code <= 4'd9;
                            else
                            ...
                            line[0] == "P" && line[1] == "R" && line[2] == "E" &&
                            line[3] == "T" && line[4] == "R" && line[5] == "I" &&
                            line[6] == "G" && line[7] == ":") begin
                            parsed_depth = 16'd0;
                            ...
                            if (parsed_depth > 16'd32767) pretrigger <= 16'd32767;
                            else pretrigger <= parsed_depth;
                        end else if (len >= 8 &&
